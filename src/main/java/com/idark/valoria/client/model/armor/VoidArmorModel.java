...
public class VoidArmorModel{
    ...
    public static MeshDefinition addPieces(CubeDeformation deformation) {
        ...
        .texOffs(56, 0).addBox(-5.75F, -2.75F, -5.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.15F))
        .texOffs(56, 0).addBox(3.75F, -2.75F, -5.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.15F))
        .texOffs(24, 4).addBox(-3.0F, -1.75F, -5.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F))
