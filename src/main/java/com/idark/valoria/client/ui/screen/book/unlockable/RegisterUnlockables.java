...
public class RegisterUnlockables{
    ...
    public static void init() {
        ...
        fortress = register(new Unlockable(Valoria.ID + ":fortress", false));
        ...
        dryador = register(new Unlockable(Valoria.ID + ":dryador", false));
        suspiciousGem = register(new ItemUnlockable(Valoria.ID + ":suspicious_gem", false, ItemsRegistry.suspciousGem.get()));
        wickedCrystal = register(new Unlockable(Valoria.ID + ":wicked_crystal", false));
