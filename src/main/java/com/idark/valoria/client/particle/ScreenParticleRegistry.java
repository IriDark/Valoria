...
public class ScreenParticleRegistry{
    ...
    public static void spawnFireParticles(ScreenParticleHolder target, ColorParticleData data){
        var rand = Minecraft.getInstance().level.getRandom();
        ...
        .setColorData(ColorParticleData.create(Pal.darkishGray, Pal.darkestGray).build())
        .setLifetime(10 + rand.nextInt(10))
        .setRandomOffset(0.05f)
        .setRandomMotion(0.05f, 0.05f)
        .spawnOnStack(0, 0);
