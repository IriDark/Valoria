...
public class Item2DRenderer {
    ...
    /**
     * Adds the mod ID where needed to search the named item
     * @see com.idark.valoria.Valoria#clientSetup(FMLClientSetupEvent) Valoria Client Setup
     */
    ...
    public static void onModelBakeEvent(ModelEvent.ModifyBakingResult event) {
        ...
        for (Item item : handModelItems) {
            for (String id : modIds) {
                ResourceLocation modelInventory = new ModelResourceLocation(new ResourceLocation(id + item), "inventory");
                ResourceLocation modelHand = new ModelResourceLocation(new ResourceLocation(id + item + "_in_hand"), "inventory");
