...
public class BlockRegistryRefactored{ //todo
    public static final DeferredRegister<Block> BLOCK = DeferredRegister.create(ForgeRegistries.BLOCKS, Valoria.ID);
    public static RegistryObject<Block>
    //wood
    eldritchDoor, eldritchTrapdoor, shadewoodDoor, shadewoodTrapdoor,
    bronzeDoor, bronzeTrapdoor, bronzeTrapdoorGlass,

    pyratiteBlock, pyratiteOre, pyratiteCrystal,
    amberBlock, amberOre, deepslateAmberOre, amberCrystal,
    sapphireBlock, sapphireOre, deepslateSapphireOre, sapphireCrystal,
    amethystBlock, amethystCrystal,
    rubyBlock, rubyOre, deepslateRubyOre, rubyCrystal,
    cobaltBlock, rawCobaltOreBlock, cobaltOre, deepslateCobaltOre,
    wickedAmethystOre, dormantCrystals, pearliumOre,

    natureBlock, aquariusBlock, infernalBlock, awakenedVoidBlock,
    ...
    eyeFlesh, eyeMeat, eyeStone,
    meatBlock, fleshBlock, fleshCyst, bloodVein,

    cobbledShale, cobbledShaleStairs, cobbledShaleSlab, cobbledShaleWall,
    polishedCobbledShale, polishedCobbledShaleStairs, polishedCobbledShaleSlab, polishedCobbledShaleWall,
    deepMarble, deepMarbleStairs, deepMarbleSlab, deepMarbleWall,
    ...
    ephemariteLowItem,  ephemariteItem,
    ...
    dunestoneBricks, dunestoneBricksStairs, dunestoneBricksSlab, dunestoneBricksWall,
    cutDunestone, polishedDunestone, //other varities?

    limestone, limestoneStairs, limestoneSlab, limestoneWall,
    cutLimestone, cutLimestoneStairs, cutLimestoneSlab,
    limestoneBricks, limestoneBricksStairs, limestoneBricksSlab, limestoneBricksWall,
    crackedLimestoneBricks, crackedLimestoneBricksStairs, crackedLimestoneBricksSlab, crackedLimestoneBricksWall,
    polishedLimestone, polishedLimestoneStairs, polishedLimestoneSlab, polishedLimestoneWall, //todo

    crystalStone, crystalStoneStairs, crystalStoneSlab, crystalStoneWall, crystalStonePillar,
    cutCrystalStone, cutPolishedCrystalStone,
    crystalStoneBricks, crystalStoneBricksStairs, crystalStoneBricksSlab, crystalStoneBricksWall,
    polishedCrystalStone, //other varities?
    pearlium,

    voidStone, voidStoneStairs, voidStoneSlab, voidStoneWall,
    voidPillar, voidPillarAmethyst, chargedVoidPillar,
    voidBrick, voidBrickStairs, voidBrickSlab, voidBrickWall,
    voidCrackedBrick, voidCrackedBrickStairs, voidCrackedBrickSlab, voidCrackedBrickWall,
    polishedVoidStone, voidFirechargeTrap, voidSpikesTrap,
    voidChiseledBrick, voidChiseledBricks, voidChiseledBricksStairs, voidChiseledBricksSlab,
    voidGrass, voidTaint, voidTaintLantern, abyssalLantern,

    tombstone, tombstoneStairs, tombstoneSlab, tombstoneWall,
    tombstoneBricks,  tombstoneBricksStairs, tombstoneBricksSlab, tombstoneBricksWall,
    crackedTombstoneBricks, crackedTombstoneBricksWall, //other varities?
    ...
    shadelog, strippedShadelog, shadewood, strippedShadewood,
    shadewoodPlanks, shadewoodPlanksStairs, shadewoodPlanksSlab,
    shadewoodLeaves, shadewoodBranch, shadewoodSapling, pottedShadewoodSapling,
    shadewoodFence, shadewoodFenceGate,
    shadewoodSign, shadewoodWallSign, shadewoodHangingSign, shadewoodWallHangingSign,

    eldritchPressurePlate, eldritchButton,
    eldritchLog, strippedEldritchLog, eldritchWood, strippedEldritchWood,
    eldritchPlanks, eldritchPlanksStairs, eldritchPlanksSlab,
    eldritchLeaves, eldritchSapling, pottedEldritchSapling,
    eldritchFence, eldritchFenceGate,
    eldritchSign, eldritchWallSign, eldritchHangingSign, eldritchWallHangingSign,

    //loot blocks
    potSmall, potSmallHandles, potLong, potLongHandles, potLongMossy, potLongMossyHandles,
    cryptPot, decoratedCryptPot,
    spiderEgg,

    //other
    valoriaPortal, valoriaPortalFrame,
    stoneCrusher, jewelerTable, keg, archaeologyTable, elementalManipulator,
    grave, tomb, mossyTomb, woodenTomb, mossyWoodenTomb, sarcophagus,
    umbralKeypad, umbralActivator, umbralBlock, cutUmbralBlock, umbralBricks,
    tile, quicksand, bronzeLamp, decoratedBronzeLamp, bronzeLampBlock,

    // decorative
    elegantPedestal,
    woodenCup, beerCup, rumCup,
    cup, teaCup, greenTeaCup, coffeeCup, cacaoCup,
    ...
    public static void load(IEventBus eventBus){
        ...
        valoriaPortal = BLOCK.register("valoria_portal", () -> new ValoriaPortalBlock(props(Blocks.NETHER_PORTAL, MapColor.COLOR_PURPLE)));
        ...
        pyratiteOre = registerBlock("pyratite_ore", () -> new DropExperienceBlock(BlockBehaviour.Properties.copy(deepMarble.get()).requiresCorrectToolForDrops().strength(10f, 12f), UniformInt.of(2, 4)));
        ...
        cobaltOre = registerBlock("cobalt_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.COAL_ORE).requiresCorrectToolForDrops()));
        rawCobaltOreBlock = registerBlock("raw_cobalt_ore", () -> new Block(props(Blocks.RAW_COPPER_BLOCK, MapColor.COLOR_BLUE).requiresCorrectToolForDrops().strength(3f, 4f)));
        deepslateCobaltOre = registerBlock("deepslate_cobalt_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.COAL_ORE).requiresCorrectToolForDrops()));
        ...
        bronzeBlockStairs = registerBlock("bronze_block_stairs", () -> new StairBlock(() -> bronzeBlock.get().defaultBlockState(), props(Blocks.IRON_BLOCK, MapColor.COLOR_BROWN).strength(2f, 4f).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
        ...
        cutBronzeStairs = registerBlock("cut_bronze_stairs", () -> new StairBlock(() -> cutBronze.get().defaultBlockState(), props(Blocks.IRON_BLOCK, MapColor.COLOR_BROWN).strength(2f, 4f).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
        ...
        cobbledShaleStairs = registerBlock("cobbled_shale_stairs", () -> new StairBlock(() -> cobbledShale.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        polishedCobbledShaleStairs = registerBlock("polished_cobbled_shale_stairs", () -> new StairBlock(() -> polishedCobbledShale.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        deepMarbleStairs = registerBlock("deep_marble_stairs", () -> new StairBlock(() -> deepMarble.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        polishedDeepMarbleStairs = registerBlock("polished_deep_marble_stairs", () -> new StairBlock(() -> polishedDeepMarble.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        picriteStairs = registerBlock("picrite_stairs", () -> new StairBlock(() -> picrite.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        polishedPicriteStairs = registerBlock("polished_picrite_stairs", () -> new StairBlock(() -> polishedPicrite.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICK_STAIRS).requiresCorrectToolForDrops()));
        ...
        ephemariteLow = BLOCK.register("ephemarite_low", () -> new Block(props(Blocks.STONE, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ephemariteLowStairs = registerBlock("ephemarite_low_stairs", () -> new StairBlock(() -> ephemariteLow.get().defaultBlockState(), props(Blocks.STONE_STAIRS, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ...
        polishedEphemariteLowStairs = registerBlock("polished_ephemarite_low_stairs", () -> new StairBlock(() -> polishedEphemariteLow.get().defaultBlockState(), props(Blocks.STONE_STAIRS, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ...
        ephemarite = BLOCK.register("ephemarite", () -> new Block(props(Blocks.STONE, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ephemariteStairs = registerBlock("ephemarite_stairs", () -> new StairBlock(() -> ephemarite.get().defaultBlockState(), props(Blocks.STONE_STAIRS, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ...
        polishedEphemariteStairs = registerBlock("polished_ephemarite_stairs", () -> new StairBlock(() -> polishedEphemarite.get().defaultBlockState(), props(Blocks.STONE, MapColor.TERRACOTTA_BROWN).requiresCorrectToolForDrops()));
        ...
        bloodVein = registerBlock("blood_vein", () -> new BloodVeinBlock(props(Blocks.STONE, MapColor.COLOR_RED).sound(SoundsRegistry.FLESH).requiresCorrectToolForDrops().noOcclusion()));
        ...
        ambaneStoneStairs = registerBlock("ambane_stone_stairs", () -> new StairBlock(() -> ambaneStone.get().defaultBlockState(), props(Blocks.STONE_STAIRS, MapColor.WARPED_WART_BLOCK).requiresCorrectToolForDrops()));
        ...
        ambaneStoneBricksStairs = registerBlock("ambane_stone_bricks_stairs", () -> new StairBlock(() -> ambaneStoneBricks.get().defaultBlockState(), props(Blocks.STONE_BRICK_STAIRS, MapColor.WARPED_WART_BLOCK).requiresCorrectToolForDrops()));
        ...
        polishedAmbaneStoneStairs = registerBlock("polished_ambane_stone_stairs", () -> new StairBlock(() -> polishedAmbaneStone.get().defaultBlockState(), props(Blocks.STONE_BRICK_STAIRS, MapColor.WARPED_WART_BLOCK).requiresCorrectToolForDrops()));
        ...
        dunestoneStairs = registerBlock("dunestone_stairs", () -> new StairBlock(() -> dunestone.get().defaultBlockState(), props(Blocks.STONE_STAIRS, MapColor.SAND).requiresCorrectToolForDrops()));
        ...
        dunestoneBricksStairs = registerBlock("dunestone_bricks_stairs", () -> new StairBlock(() -> dunestoneBricks.get().defaultBlockState(), props(Blocks.STONE_BRICK_STAIRS, MapColor.SAND).requiresCorrectToolForDrops()));
        ...
        () -> new StairBlock(() -> voidStone.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_PURPLE).strength(3f, 6f).sound(SoundsRegistry.VOID_STONE).requiresCorrectToolForDrops()));
        ...
        () -> new StairBlock(() -> voidBrick.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_PURPLE).strength(3f, 6f).requiresCorrectToolForDrops().sound(SoundsRegistry.VOID_STONE)));
        ...
        () -> new StairBlock(() -> voidCrackedBrick.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_PURPLE).strength(3f, 6f).requiresCorrectToolForDrops().sound(SoundsRegistry.VOID_STONE)));
        ...
        () -> new StairBlock(() -> voidChiseledBricks.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_PURPLE).strength(3f, 6f).requiresCorrectToolForDrops()));
        ...
        () -> new SpikeTrapBlock(BlockRegistry.POLISHED_TOMBSTONE.get().defaultBlockState(), spikes.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(3f, 4f)));
        ...
        () -> new StairBlock(() -> tombstoneBricks.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).mapColor(MapColor.COLOR_BLACK).requiresCorrectToolForDrops().sound(SoundsRegistry.TOMBSTONE_BRICKS)));
        ...
        shadewoodPressurePlate = registerBlock("shadewood_button",
        ...
        () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_PURPLE)));
        strippedShadelog = registerBlock("stripped_shadewood",
        () -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).mapColor(MapColor.COLOR_PURPLE)));
        ...
        () -> new StairBlock(() -> shadewoodPlanks.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS).mapColor(MapColor.COLOR_PURPLE)));
        ...
        () -> new FlowerPotBlock(shadewoodSapling.get(), BlockBehaviour.Properties.copy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_CYAN).instabreak().noOcclusion()));
        ...
        () -> new StairBlock(() -> eldritchPlanks.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.OAK_STAIRS).mapColor(MapColor.COLOR_PURPLE)));
        ...
        () -> new FlowerPotBlock(eldritchSapling.get(), BlockBehaviour.Properties.copy(Blocks.POTTED_POPPY).mapColor(MapColor.COLOR_MAGENTA).instabreak().noOcclusion()));
        ...
        beerCup = BLOCK.register("beer_cup", BlockRegistryRefactored::woodenCup);
        rumCup = BLOCK.register("rum_cup", BlockRegistryRefactored::woodenCup);

        cup = BLOCK.register("cup", BlockRegistryRefactored::cup);
        teaCup = BLOCK.register("tea_cup", BlockRegistryRefactored::cup);
        greenTeaCup = BLOCK.register("green_tea_cup", BlockRegistryRefactored::cup);
        coffeeCup = BLOCK.register("coffee_cup", BlockRegistryRefactored::cup);
        cacaoCup = BLOCK.register("cacao_cup", BlockRegistryRefactored::cup);
