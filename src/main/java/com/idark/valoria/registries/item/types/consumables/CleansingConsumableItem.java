...
public class CleansingConsumableItem extends AbstractConsumableItem{
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
        ...
        Utils.Items.effectTooltip(ImmutableList.of(new MobEffectInstance(effect)), pTooltipComponents, 1, 1);
    }
