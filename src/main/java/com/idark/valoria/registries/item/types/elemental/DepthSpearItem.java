...
public class DepthSpearItem extends SpearItem{
    ...
    public DepthSpearItem(Tier tier, float attackDamageIn, float attackSpeedIn, Properties builderIn, MobEffectInstance... pEffects){
        super(tier, attackDamageIn, attackSpeedIn, builderIn, pEffects);
    }

    public DepthSpearItem(Tier tier, float attackDamageIn, float attackSpeedIn, boolean pThrowable, Properties builderIn){
        super(tier, attackDamageIn, attackSpeedIn, pThrowable, builderIn);
    }

    public DepthSpearItem(Tier tier, float attackDamageIn, float attackSpeedIn, float pChance, Properties builderIn, MobEffectInstance... pEffects){
    ...
    public Multimap<Attribute, AttributeModifier> createAttributes(){
        ...
        builder.put(AttributeReg.DEPTH_DAMAGE.get(), new AttributeModifier(Valoria.BASE_DEPTH_DAMAGE_UUID, "Weapon modifier", 3, AttributeModifier.Operation.ADDITION));
