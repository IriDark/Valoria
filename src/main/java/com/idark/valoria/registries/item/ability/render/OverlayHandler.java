package com.idark.valoria.registries.item.ability.render;
...
public class OverlayHandler{
    ...
    private static CompoundTag cachedNBT = null;
    ...
    private static void render(ItemStack stack, Minecraft mc, GuiGraphics gui){
        CompoundTag currentNBT = stack.getTag();
        if (stack != cachedStack || !Objects.equals(currentNBT, cachedNBT)) {
            cachedStack = stack;
            cachedNBT = currentNBT != null ? currentNBT.copy() : null;
        ...
        for (int i = 0; i < abilities.size(); i++){
            ...
            if (tag != null && tag.contains("ability_cooldowns")) {
                CompoundTag cdTag = tag.getCompound("ability_cooldowns");
                ...
                if (cdTag.contains(id)) {
                    ...
                    if (currentTime < endTime) {
                        ...
                        RenderSystem.setShaderColor(255, 255, 255, 0.75f);
