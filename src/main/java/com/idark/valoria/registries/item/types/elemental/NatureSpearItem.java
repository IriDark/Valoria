...
public class NatureSpearItem extends SpearItem{
    ...
    public Multimap<Attribute, AttributeModifier> createAttributes(){
        ...
        builder.put(AttributeReg.NATURE_DAMAGE.get(), new AttributeModifier(Valoria.BASE_NATURE_DAMAGE_UUID, "Weapon modifier", 3, AttributeModifier.Operation.ADDITION));
