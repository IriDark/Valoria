...
public class ArmorRegistry implements ArmorMaterial{
    ...
    public static final ArmorRegistry MARSH = new ArmorRegistry.Builder("marsh").protection(24).mul(58).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.marshCloth.get())).build();
