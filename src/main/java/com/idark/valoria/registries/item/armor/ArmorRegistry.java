...
public class ArmorRegistry implements ArmorMaterial{
    ...
    public static final ArmorRegistry SPIDER = new ArmorRegistry.Builder("spider").protection(22).mul(68).enchantValue(14).knockbackRes(0.12f).ingredient(() -> Ingredient.of(ItemsRegistry.spiderFang.get())).build();
    public static final ArmorRegistry NATURE = new ArmorRegistry.Builder("nature").protection(24).mul(66).enchantValue(16).ingredient(() -> Ingredient.of(ItemsRegistry.natureIngot.get())).build();
    public static final ArmorRegistry DEPTH = new ArmorRegistry.Builder("depth").protection(26).mul(72).enchantValue(16).ingredient(() -> Ingredient.of(ItemsRegistry.aquariusIngot.get())).build();
    public static final ArmorRegistry INFERNAL = new ArmorRegistry.Builder("infernal").protection(28).mul(76).enchantValue(14).ingredient(() -> Ingredient.of(ItemsRegistry.infernalIngot.get())).build();
    public static final ArmorRegistry VOID = new ArmorRegistry.Builder("awakened_void").protection(30).mul(76).enchantValue(10).ingredient(() -> Ingredient.of(ItemsRegistry.voidIngot.get())).build();
    public static final ArmorRegistry PHANTASM = new ArmorRegistry.Builder("phantasm").protection(35).mul(82).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.illusionStone.get())).build();
