...
public class ArmorRegistry implements ArmorMaterial{
    ...
    public static final ArmorRegistry PYRATITE = new ArmorRegistry.Builder("pyratite").protection(45).mul(72).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.pyratite.get())).build();
