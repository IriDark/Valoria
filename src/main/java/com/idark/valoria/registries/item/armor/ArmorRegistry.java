...
public class ArmorRegistry extends AbstractArmorRegistry{
    ...
    public static final ArmorRegistry ETHEREAL = new ArmorRegistry.Builder("ethereal").effects(etherealData).protection(30).mul(60).enchantValue(18).knockbackRes(0.1f).ingredient(() -> Ingredient.of(ItemsRegistry.etherealShard.get())).build();
    public static final ArmorRegistry NATURE = new ArmorRegistry.Builder("nature").effects(natureData).protection(40).mul(66).enchantValue(16).knockbackRes(0.10f).ingredient(() -> Ingredient.of(ItemsRegistry.natureIngot.get())).build();
    public static final ArmorRegistry DEPTH = new ArmorRegistry.Builder("depth").effects(depthData).protection(45).mul(72).enchantValue(16).knockbackRes(0.10f).ingredient(() -> Ingredient.of(ItemsRegistry.aquariusIngot.get())).build();
    public static final ArmorRegistry INFERNAL = new ArmorRegistry.Builder("infernal").effects(infernalData).protection(50).mul(76).enchantValue(14).knockbackRes(0.12f).ingredient(() -> Ingredient.of(ItemsRegistry.infernalIngot.get())).build();
    public static final ArmorRegistry SPIDER = new ArmorRegistry.Builder("spider").setVoidDefence(25).protection(55).mul(68).enchantValue(14).knockbackRes(0.10f).ingredient(() -> Ingredient.of(ItemsRegistry.spiderFang.get())).build();
    public static final ArmorRegistry PYRATITE = new ArmorRegistry.Builder("pyratite").setVoidDefence(15).protection(50).mul(72).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.pyratite.get())).build();
    public static final ArmorRegistry CRIMTANE = new ArmorRegistry.Builder("crimtane").setVoidDefence(35).hitEffects(crimtaneData).protection(60).mul(72).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.painCrystal.get())).build();
    public static final ArmorRegistry VOID = new ArmorRegistry.Builder("awakened_void").setVoidDefence(75).protection(65).mul(80).enchantValue(10).knockbackRes(0.15f).ingredient(() -> Ingredient.of(ItemsRegistry.voidIngot.get())).build();
    public static final ArmorRegistry PHANTASM = new ArmorRegistry.Builder("phantasm").setVoidDefence(100).protection(70).mul(85).enchantValue(12).knockbackRes(0.25f).ingredient(() -> Ingredient.of(ItemsRegistry.illusionStone.get())).build();
