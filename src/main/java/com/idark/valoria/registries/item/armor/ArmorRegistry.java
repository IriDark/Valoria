...
public class ArmorRegistry extends AbstractArmorRegistry{
    ...
    public static final ArmorRegistry FALLEN_COLLECTOR = new ArmorRegistry.Builder("fallen_collector").addAttr(AttributeReg.SUMMON_DAMAGE, new AttributeData(0.1f, Operation.MULTIPLY_BASE)).addAttr(AttributeReg.NECROMANCY_COUNT, new AttributeData(1, Operation.ADDITION)).protection(25).mul(45).enchantValue(20).ingredient(() -> Ingredient.of(Items.LEATHER)).build();
    public static final ArmorRegistry MARSH = new ArmorRegistry.Builder("marsh").addAttr(AttributeReg.SUMMON_DAMAGE, new AttributeData(0.05f, Operation.MULTIPLY_BASE)).addAttr(AttributeReg.NECROMANCY_COUNT, new AttributeData(1, Operation.ADDITION)).protection(20).mul(58).enchantValue(12).ingredient(() -> Ingredient.of(ItemsRegistry.marshCloth.get())).build();
