...
public class ItemTierRegistry{
    ...
    public static Tier NONE = registerTier(new ForgeTier(4, 1561, 10f, 4.0F, 15, BlockTags.NEEDS_IRON_TOOL, Ingredient::of), Valoria.loc("none"));
    ...
    public static Tier HOLIDAY = registerTier(new ForgeTier(2, 740, 5f, 2.0F, 8, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.holidayCandy.get())), Valoria.loc("holiday"));
    public static Tier HALLOWEEN = registerTier(new ForgeTier(3, 1150, 6f, 3.0F, 8, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.candyCorn.get())), Valoria.loc("halloween"));
    public static Tier SAMURAI = registerTier(new ForgeTier(3, 1250, 10f, 5.0F, 7, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.ancientIngot.get())), Valoria.loc("samurai"));
    ...
    public static Tier SPIDER = TierSortingRegistry.registerTier(new ForgeTier(5, 2831, 22f, 11F, 15, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.spiderFang.get())), Valoria.loc("spider"), List.of(Tiers.NETHERITE), List.of(Valoria.loc("depth")));
    public static Tier PYRATITE = TierSortingRegistry.registerTier(new ForgeTier(6, 3112, 24f, 13F, 15, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.pyratite.get())), Valoria.loc("pyratite"), List.of(Tiers.NETHERITE), List.of(Valoria.loc("depth")));
    public static Tier BLOOD = TierSortingRegistry.registerTier(new ForgeTier(5, 2431, 24.0F, 15.0F, 15, BlockTags.NEEDS_IRON_TOOL, () -> Ingredient.of(ItemsRegistry.painCrystal.get())), Valoria.loc("meat"), List.of(Tiers.NETHERITE), List.of(Valoria.loc("depth")));
    ...
    public static Tier PHANTOM = TierSortingRegistry.registerTier(new ForgeTier(5, 6428, 35F, 20F, 20, Blocks.NEEDS_NETHERITE_TOOL, () -> Ingredient.of(ItemsRegistry.illusionStone.get())), Valoria.loc("phantom"), List.of(Valoria.loc("void")), List.of());
