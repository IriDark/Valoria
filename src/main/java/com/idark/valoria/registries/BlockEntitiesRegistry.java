...
public class BlockEntitiesRegistry {
    ...
    public static final RegistryObject<BlockEntityType<FleshCystBlockEntity>> FLESH_CYST = BLOCK_ENTITIES.register("flesh_cyst", () -> Builder.of(FleshCystBlockEntity::new, BlockRegistry.FLESH_CYST.get()).build(null));
