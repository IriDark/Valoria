...
public class EntityTypeRegistry{
    ...
    public static final RegistryObject<EntityType<NatureArrow>> NATURE_ARROW = register("nature_arrow", EntityType.Builder.<NatureArrow>of(NatureArrow::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
    ...
    public static final RegistryObject<EntityType<KunaiProjectile>> KUNAI = register("kunai", EntityType.Builder.<KunaiProjectile>of(KunaiProjectile::new, MobCategory.MISC).sized(0.35f, 0.35f).clientTrackingRange(4).updateInterval(20));
    ...
    public static final RegistryObject<EntityType<Firron>> FIRRON = register("firron", EntityType.Builder.of(Firron::new, MobCategory.MONSTER).fireImmune().sized(2.35f, 4.5f).clientTrackingRange(8));
