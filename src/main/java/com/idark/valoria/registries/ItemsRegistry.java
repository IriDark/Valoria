...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> NATURE_GIFT = ITEMS.register("nature_gift", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.nature, Pal.vividCyan, 0.35f, new Item.Properties().stacksTo(16).rarity(RarityRegistry.NATURE)));
    public static final RegistryObject<Item> OCEANIC_SHELL = ITEMS.register("oceanic_shell", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.oceanic, Pal.magmatic, 0.35f, new Item.Properties().stacksTo(16).rarity(RarityRegistry.AQUARIUS)));
    public static final RegistryObject<Item> INFERNAL_STONE = ITEMS.register("infernal_stone", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.infernalBright, Pal.magmatic, 0.35f, new Item.Properties().stacksTo(16).rarity(RarityRegistry.INFERNAL)));
    public static final RegistryObject<Item> BONE_FRAGMENT = ITEMS.register("bone_fragment", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.vividGreen, Pal.cyan, 0.35f, new Item.Properties().stacksTo(16)));
    public static final RegistryObject<Item> PAIN_CRYSTAL = ITEMS.register("pain_crystal", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.strongRed, Pal.moderateViolet, 0.35f, new Item.Properties().stacksTo(16)));
    public static final RegistryObject<Item> NIHILITY_SHARD = ITEMS.register("nihility_shard", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.softMagenta, Pal.softMagenta, 0.35f, new Item.Properties().stacksTo(16).rarity(RarityRegistry.VOID)));
    public static final RegistryObject<Item> ILLUSION_STONE = ITEMS.register("illusion_stone", () -> new ParticleMaterialItem(ParticleRegistry.SPHERE.get(), Pal.softBlue, Color.white, 0.35f, new Item.Properties().stacksTo(16).rarity(RarityRegistry.PHANTASM)));

    public static final RegistryObject<Item> NATURE_CORE = ITEMS.register("nature_core", () -> new CoreItem(ParticleRegistry.SPHERE.get(), new Item.Properties().fireResistant().rarity(RarityRegistry.NATURE), 8, Pal.nature, Pal.vividCyan, "nature_core"));
    public static final RegistryObject<Item> AQUARIUS_CORE = ITEMS.register("aquarius_core", () -> new CoreItem(ParticleRegistry.SPHERE.get(), new Item.Properties().fireResistant().rarity(RarityRegistry.AQUARIUS), 8, Pal.oceanic, Pal.magmatic, "aquarius_core"));
    public static final RegistryObject<Item> INFERNAL_CORE = ITEMS.register("infernal_core", () -> new CoreItem(ParticleRegistry.SPHERE.get(), new Item.Properties().fireResistant().rarity(RarityRegistry.INFERNAL), 8, Pal.infernalBright, Pal.magmatic, "infernal_core"));
    public static final RegistryObject<Item> VOID_CORE = ITEMS.register("void_core", () -> new CoreItem(ParticleRegistry.SPHERE.get(), new Item.Properties().fireResistant().rarity(RarityRegistry.VOID), 8, Pal.softMagenta, Pal.softMagenta, "void_core"));
    ...
    public static final RegistryObject<Item> SAKE_BOTTLE = ITEMS.register("sake_bottle", () -> new PlaceableDrinkItem(BlockRegistry.SAKE_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 700, 1), new MobEffectInstance(MobEffects.CONFUSION, 160)));
    public static final RegistryObject<Item> LIQUOR_BOTTLE = ITEMS.register("liquor_bottle", () -> new PlaceableDrinkItem(BlockRegistry.LIQUOR_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 350, 1), new MobEffectInstance(MobEffects.CONFUSION, 120)));
    public static final RegistryObject<Item> RUM_BOTTLE = ITEMS.register("rum_bottle", () -> new PlaceableDrinkItem(BlockRegistry.RUM_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 650, 1), new MobEffectInstance(MobEffects.CONFUSION, 250)));
    public static final RegistryObject<Item> MEAD_BOTTLE = ITEMS.register("mead_bottle", () -> new PlaceableDrinkItem(BlockRegistry.MEAD_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 700, 0), new MobEffectInstance(MobEffects.CONFUSION, 240)));
    public static final RegistryObject<Item> COGNAC_BOTTLE = ITEMS.register("cognac_bottle", () -> new PlaceableDrinkItem(BlockRegistry.COGNAC_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 800, 1), new MobEffectInstance(MobEffects.CONFUSION, 350)));
    public static final RegistryObject<Item> WHISKEY_BOTTLE = ITEMS.register("whiskey_bottle", () -> new PlaceableDrinkItem(BlockRegistry.WHISKEY_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(EffectsRegistry.TIPSY.get(), 450, 1), new MobEffectInstance(MobEffects.CONFUSION, 150)));
    public static final RegistryObject<Item> COKE_BOTTLE = ITEMS.register("coke_bottle", () -> new PlaceableDrinkItem(BlockRegistry.COKE_BOTTLE.get(), 0, 1, 64, ItemsRegistry.BOTTLE.get(), new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 250)));
    ...
    public static final RegistryObject<Item> HOLIDAY_CANDY = ITEMS.register("holiday_candy", () -> new Item(new Item.Properties().stacksTo(64).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.2f).build())));
    ...
    public static final RegistryObject<Item> MURASAMA = ITEMS.register("murasama",
            () -> new MurasamaItem(ModItemTier.SAMURAI, 9, -2.4f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> CANDY_CORN = ITEMS.register("candy_corn",
            () -> new Item(new Item.Properties().rarity(RarityRegistry.HALLOWEEN).stacksTo(64).food(new FoodProperties.Builder().nutrition(1).saturationMod(0.2f).build())));
    ...
    public static final RegistryObject<Item> HOLIDAY_KATANA = ITEMS.register("holiday_katana",
            () -> new KatanaItem(ModItemTier.HOLIDAY, 2, -2.2f, new Item.Properties()));
    ...
    public static final RegistryObject<Item> NETHERITE_KATANA = ITEMS.register("netherite_katana",
            () -> new KatanaItem(Tiers.NETHERITE, 5, -1.8f, 1.5f, new Item.Properties().fireResistant()));
    public static final RegistryObject<Item> SAMURAI_KATANA = ITEMS.register("samurai_katana",
            () -> new KatanaItem(ModItemTier.SAMURAI, 7, -2f, new Item.Properties()));
