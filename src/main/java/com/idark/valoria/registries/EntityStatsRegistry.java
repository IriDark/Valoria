...
public class EntityStatsRegistry{
    ...
    //monsters - overworld
    public static AttributeSupplier GOBLIN = register(25, 5).add(Attributes.MOVEMENT_SPEED, 0.17).build();
    ...
    public static AttributeSupplier NECROMANCER = register(100, 10).add(Attributes.ARMOR, 10).add(Attributes.ARMOR_TOUGHNESS, 5).build();
