...
public class EntityStatsRegistry{
    ...
    public static AttributeSupplier ENT = register(50, 2, 0.15).add(Attributes.ARMOR, 5).add(Attributes.ARMOR_TOUGHNESS, 2).add(Attributes.KNOCKBACK_RESISTANCE, 0.5).build();
