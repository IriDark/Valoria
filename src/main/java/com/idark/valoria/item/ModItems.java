...
import com.idark.valoria.item.curio.charm.*;
import com.idark.valoria.item.food.*;
...
public class ModItems {
	...
	public static final RegistryObject<Item> BEER_CUP = ITEMS.register("beer_cup", () -> new AlcoholCupItem(100, 0, false));
	public static final RegistryObject<Item> RUM_CUP = ITEMS.register("rum_cup", () -> new AlcoholCupItem(150, 1, false));
	public static final RegistryObject<Item> KVASS_BOTTLE = ITEMS.register("kvass_bottle", () -> new AlcoholCupItem(125, 0, true));
	public static final RegistryObject<Item> VINE_BOTTLE = ITEMS.register("vine_bottle", () -> new AlcoholCupItem(325, 0, true));
