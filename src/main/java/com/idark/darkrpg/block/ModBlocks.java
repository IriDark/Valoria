...
import java.util.function.ToIntFunction;
	...
	() -> new DoorBlock(AbstractBlock.Properties.of(Material.WOOD).harvestLevel(1).requiresCorrectToolForDrops().harvestTool(ToolType.AXE).strength(2f).noOcclusion()));
	public static final RegistryObject<Block> SHADEWOOD_TRAPDOOR = registerBlock("shadewood_trapdoor",
	() -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD).harvestLevel(1).requiresCorrectToolForDrops().harvestTool(ToolType.AXE).strength(1f).noOcclusion()));
	public static final RegistryObject<Block> BRONZE_DOOR = registerBlock("bronze_door",
	() -> new DoorBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(4f).noOcclusion()));
	public static final RegistryObject<Block> BRONZE_TRAPDOOR2 = registerBlock("bronze_trapdoor2",
	() -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(2f).noOcclusion()));
	public static final RegistryObject<Block> BRONZE_TRAPDOOR = registerBlock("bronze_trapdoor",
	() -> new TrapDoorBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(3f).noOcclusion()));
	// Key
	public static final RegistryObject<Block> KEYBLOCK = BLOCK.register("keyblock",
	() -> new KeyPadBlock(Properties.of(Material.METAL).strength(-1f, 3600000.8F).sound(SoundType.NETHER_BRICKS)));
	public static final RegistryObject<Block> KEYBLOCK_BRICKS = BLOCK.register("keyblock_bricks",
	() -> new Block(Properties.of(Material.METAL).strength(-1f, 3600000.8F).sound(SoundType.NETHER_BRICKS)));
	public static final RegistryObject<Block> KEYBLOCK_RUNE = BLOCK.register("keyblock_rune",
	() -> new KeyBlock(Properties.of(Material.METAL).strength(-1f, 3600000.8F).sound(SoundType.NETHER_BRICKS)));
	// Metal
	public static final RegistryObject<Block> COBALT_BLOCK = BLOCK.register("cobalt_block",
	() -> new Block(Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).sound(SoundType.NETHERITE_BLOCK)));
	...
	() -> new InfernalBlock(Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).sound(SoundType.NETHERITE_BLOCK)));
	...
	() -> new StairsBlock(() -> BRONZE_BLOCK.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
	public static final RegistryObject<Block> BRONZE_BLOCK_SLAB = registerBlock("bronze_block_slab",
	() -> new SlabBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).sound(SoundType.NETHERITE_BLOCK).strength(6f)));
	...
	() -> new StairsBlock(() -> BRONZE_PLATE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
	public static final RegistryObject<Block> BRONZE_PLATE_SLAB = registerBlock("bronze_plate_slab",
	() -> new SlabBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(6f).sound(SoundType.NETHERITE_BLOCK)));
	...
	() -> new StairsBlock(() -> CUT_BRONZE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.NETHERITE_BLOCK)));
	...
	() -> new GlassBlock(Properties.of(Material.GLASS).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1f).noOcclusion().sound(SoundType.GLASS)));
	// Stone Types
	public static final RegistryObject<Block> AMBANE_STONE = BLOCK.register("ambane_stone",
	() -> new Block(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> AMBANE_STONE_STAIRS = registerBlock("ambane_stone_stairs",
	() -> new StairsBlock(() -> AMBANE_STONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> AMBANE_STONE_SLAB = registerBlock("ambane_stone_slab",
	() -> new SlabBlock(AbstractBlock.Properties.of(Material.STONE).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(6f)));
	public static final RegistryObject<Block> AMBANE_STONE_WALL = BLOCK.register("ambane_stone_wall",
	() -> new WallBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	...
	() -> new StairsBlock(() -> AMBANE_STONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> POLISHED_AMBANE_STONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> DUNESTONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> DUNESTONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> LIMESTONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> CUT_LIMESTONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> LIMESTONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> CRACKED_LIMESTONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new Block(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> CRACKED_TOMBSTONE_BRICKS_WALL = BLOCK.register("cracked_tombstone_bricks_wall",
	() -> new WallBlock(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	...
	() -> new SlabBlock(AbstractBlock.Properties.of(Material.STONE).harvestLevel(2).requiresCorrectToolForDrops().harvestTool(ToolType.PICKAXE).strength(6f).sound(SoundType.NETHER_BRICKS)));
	public static final RegistryObject<Block> CRYSTAL_STONE_STAIRS = registerBlock("crystal_stone_stairs",
	() -> new StairsBlock(() -> CRYSTAL_STONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new RotatedPillarBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	...
	() -> new RotatedPillarBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(2f).sound(SoundType.NETHER_BRICKS)));
	...
	() -> new StairsBlock(() -> POLISHED_LIMESTONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new Block(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).sound(SoundType.NETHER_BRICKS)));
	...
	() -> new StairsBlock(() -> VOID_STONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).sound(SoundType.NETHER_BRICKS).requiresCorrectToolForDrops()));
	...
	() -> new WallBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).sound(SoundType.NETHER_BRICKS)));
	...
	() -> new Block(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(2f).sound(SoundType.NETHER_BRICKS)));
	public static final RegistryObject<Block> VOID_BRICK_STAIRS = registerBlock("void_brick_stairs",
	() -> new StairsBlock(() -> VOID_BRICK.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS)));
	...
	() -> new Block(Properties.of(Material.STONE).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(2f).sound(SoundType.NETHER_BRICKS)));
	public static final RegistryObject<Block> VOID_CRACKED_BRICK_STAIRS = registerBlock("void_cracked_brick_stairs",
	() -> new StairsBlock(() -> VOID_CRACKED_BRICK.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(1).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS)));
	...
	() -> new StairsBlock(() -> VOID_CHISELED_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new VoidGrassBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).sound(SoundType.NETHER_BRICKS)));
	...
	() -> new SpikeTrapBlock(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> SPIKES = BLOCK.register("spikes",
	() -> new SpikeBlock(Properties.of(Material.STONE).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(-1f, 3600000.8F)));
	...
	() -> new FireTrapBlock(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> TOMBSTONE.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new StairsBlock(() -> TOMBSTONE_BRICKS.get().defaultBlockState(), AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).strength(2f).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops()));
	...
	() -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.copy(Blocks.OAK_PLANKS).noOcclusion().noCollission()));
	public static final RegistryObject<Block> SHADEWOOD_BUTTON = BLOCK.register("shadewood_button",
	() -> new WoodButtonBlock(AbstractBlock.Properties.copy(Blocks.OAK_WOOD).noCollission()));
	...
	() -> new StairsBlock(() -> SHADEWOOD_PLANKS.get().defaultBlockState(), AbstractBlock.Properties.copy(Blocks.OAK_STAIRS)));
	...
	() -> new ShadeSaplingBlock(new ShadeWoodTree(), AbstractBlock.Properties.copy(Blocks.OAK_SAPLING)));
    public static final RegistryObject<Block> POTTED_SHADEWOOD_SAPLING = BLOCK.register("potted_shadewood_sapling",
	() -> new FlowerPotBlock(SHADEWOOD_SAPLING.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	// Signs
	public static final RegistryObject<Block> SHADEWOOD_SIGN = BLOCK.register("shadewood_sign",
    () -> new ModStandingSignBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().noCollission(), ModWoodTypes.SHADEWOOD));
    public static final RegistryObject<Block> SHADEWOOD_WALL_SIGN = BLOCK.register("shadewood_wall_sign",
    () -> new ModWallSignBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().noCollission(), ModWoodTypes.SHADEWOOD));
	// Other
	public static final RegistryObject<Block> GEODITE_DIRT = BLOCK.register("geodite_dirt",
	() -> new Block(Properties.of(Material.GRASS).harvestLevel(2).strength(1f).sound(SoundType.GRASS)));	
	public static final RegistryObject<Block> GEODITE_STONE = BLOCK.register("geodite_stone",
	() -> new Block(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(2f)));		
	public static final RegistryObject<Block> STONE_CRUSHER = BLOCK.register("stone_crusher",
	() -> new CrusherBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1f)));	
	public static final RegistryObject<Block> JEWELER_TABLE = BLOCK.register("jeweler_table",
	() -> new JewelerBlock(Properties.of(Material.STONE).harvestLevel(1).harvestTool(ToolType.AXE).requiresCorrectToolForDrops().strength(1f)));	
	public static final RegistryObject<Block> TOMB = BLOCK.register("tomb",
	() -> new TombBlock(Properties.of(Material.STONE).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(1f)));
	public static final RegistryObject<Block> KEG = BLOCK.register("keg", 
	() -> new KegBlock(AbstractBlock.Properties.of(Material.WOOD).harvestLevel(1).harvestTool(ToolType.AXE).requiresCorrectToolForDrops().strength(1f)));
	public static final RegistryObject<Block> SARCOPHAGUS = BLOCK.register("sarcophagus", 
	() -> new SarcoBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> SARCO_HALF = BLOCK.register("sarcophagus_half", 
	() -> new SarcoHalfBlock(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> PLATE = BLOCK.register("plate", 
	() -> new Block(AbstractBlock.Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f)));
	public static final RegistryObject<Block> QUICKSAND = BLOCK.register("quicksand", 
	() -> new QuickSandBlock(Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.SHOVEL).requiresCorrectToolForDrops().strength(3f).sound(SoundType.SAND)));
	public static final RegistryObject<Block> ELEMENTAL_MANIPULATOR = BLOCK.register("elemental_manipulator", 
	() -> new ManipulatorBlock(Properties.of(Material.METAL).harvestLevel(2).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).lightLevel(s -> 4).noOcclusion()));
	public static final RegistryObject<Block> SKULLY_PEDESTAL = BLOCK.register("skully_pedestal", 
	() -> new PedestalBlock(Properties.of(Material.STONE).harvestLevel(1).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(3f).noOcclusion()));
	...
	() -> new RedstoneLampBlock(Properties.of(Material.METAL).harvestLevel(0).strength(3f).noOcclusion().sound(SoundType.GLASS).lightLevel(getLightValueLit(13))));
	...
	() -> new SpiderBlock(Properties.of(Material.STONE).harvestLevel(0).instabreak().noOcclusion().sound(ModSoundRegistry.SPIDER_EGG)));
	// Ore
	...
	() -> new Block(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(4f)));
	public static final RegistryObject<Block> WICKED_AMETHYST_ORE = BLOCK.register("wicked_amethyst_ore",
	() -> new WickedOreBlock(Properties.of(Material.STONE).harvestLevel(3).harvestTool(ToolType.PICKAXE).requiresCorrectToolForDrops().strength(4f).sound(SoundType.NETHER_BRICKS)));
	...
	() -> new CrystalBlock(Properties.of(Material.METAL).harvestLevel(2).strength(1f).sound(SoundType.GLASS).noOcclusion()));
	...
	() -> new PotBlock(Properties.of(Material.GLASS).harvestLevel(0).instabreak().noOcclusion().sound(ModSoundRegistry.POT)));
	public static final RegistryObject<Block> POT_SMALL_HANDLESS = BLOCK.register("pot_small_handless", 
	() -> new PotBlock(Properties.of(Material.GLASS).dropsLike(ModBlocks.POT_SMALL.get()).harvestLevel(0).instabreak().noOcclusion().sound(ModSoundRegistry.POT)));
	...
	() -> new PotBlock(Properties.of(Material.GLASS).dropsLike(ModBlocks.POT_LONG.get()).harvestLevel(0).instabreak().noOcclusion().sound(ModSoundRegistry.POT)));
	...
	() -> new DeadBushBlock(Properties.copy(Blocks.SUNFLOWER)));
    public static final RegistryObject<Block> POTTED_ALOE_SMALL = BLOCK.register("potted_aloe_small",
	() -> new FlowerPotBlock(ALOE_SMALL.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> DRIED_PLANT = BLOCK.register("dried_plant",
	() -> new DriedBlock(Properties.copy(Blocks.SUNFLOWER)));
    public static final RegistryObject<Block> POTTED_DRIED_PLANT = BLOCK.register("potted_dried_plant",
	() -> new FlowerPotBlock(DRIED_PLANT.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	...
	() -> new FlowerPotBlock(DRIED_ROOTS.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> ALOE = BLOCK.register("aloe",
	() -> new TallSandFlowerBlock(Properties.copy(Blocks.SUNFLOWER)));	
	public static final RegistryObject<Block> CATTAIL = BLOCK.register("cattail",
	() -> new TallWaterFlowerBlock(Properties.copy(Blocks.SUNFLOWER)));	
	public static final RegistryObject<Block> SOULROOT = BLOCK.register("soulroot",
	() -> new NetherRootsBlock(AbstractBlock.Properties.copy(Blocks.CRIMSON_ROOTS)));
    public static final RegistryObject<Block> POTTED_SOULROOT = BLOCK.register("potted_soulroot",
	() -> new FlowerPotBlock(SOULROOT.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	...
	() -> new FlowerPotBlock(CRIMSON_SOULROOT.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));	
	public static final RegistryObject<Block> DOUBLE_SOULROOT = BLOCK.register("double_crimson_soulroot",
	() -> new TallNetherFlowerBlock(AbstractBlock.Properties.copy(Blocks.CRIMSON_ROOTS)));
	...
	() -> new FlowerPotBlock(MAGMAROOT.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> DOUBLE_MAGMAROOT = BLOCK.register("double_crimson_magmaroot",
	() -> new TallNetherFlowerBlock(Properties.copy(Blocks.SUNFLOWER)));
	...
	() -> new FlowerPotBlock(GOLDY.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	...
	() -> new FlowerPotBlock(BLOODROOT.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));	
	...
	() -> new FlowerPotBlock(RAJUSH.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> FALSEFLOWER = BLOCK.register("falseflower",
	() -> new VoidFlowerBlock(Effects.POISON, 2, AbstractBlock.Properties.copy(Blocks.CRIMSON_ROOTS)));
    public static final RegistryObject<Block> POTTED_FALSEFLOWER = BLOCK.register("potted_falseflower",
	() -> new FlowerPotBlock(FALSEFLOWER.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	...
	() -> new FlowerPotBlock(FALSEFLOWER_SMALL.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> SOULFLOWER = BLOCK.register("soulflower",
	() -> new VoidFlowerBlock(Effects.NIGHT_VISION, 5, AbstractBlock.Properties.copy(Blocks.CRIMSON_ROOTS)));
    public static final RegistryObject<Block> POTTED_SOULFLOWER = BLOCK.register("potted_soulflower",
	() -> new FlowerPotBlock(SOULFLOWER.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> VOID_ROOTS = BLOCK.register("void_roots",
	() -> new VoidRootsBlock(AbstractBlock.Properties.copy(Blocks.CRIMSON_ROOTS)));
    public static final RegistryObject<Block> POTTED_VOID_ROOTS = BLOCK.register("potted_void_roots",
	() -> new FlowerPotBlock(VOID_ROOTS.get(), AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()));
	public static final RegistryObject<Block> GAIB_ROOTS = BLOCK.register("gaib_roots",
	() -> new TallRootsBlock(Properties.copy(Blocks.CRIMSON_ROOTS)));
	...
	private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
		...
		new Item.Properties().tab(ModItemGroup.DARKRPG_BLOCKS_GROUP)));
	}
