...
public class CurioIronEmerald extends RPGCurioItem {
	private static final ResourceLocation TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/iron_necklace_emerald.png");
	public CurioIronEmerald(Properties properties) {
        super(properties);
	}
