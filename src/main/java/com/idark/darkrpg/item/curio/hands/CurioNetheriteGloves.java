...
public class CurioNetheriteGloves extends RPGCurioItem {
	
   private static final ResourceLocation GLOVES_TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/netherite_gloves.png");
