...
public class CurioGoldSapphire extends RPGCurioItem {
	
   public CurioGoldSapphire(Properties properties) {
        super(properties);
	}
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
		...
		atts.put(ForgeMod.SWIM_SPEED.get(), new AttributeModifier(uuid, "bonus",0.2, AttributeModifier.Operation.ADDITION ));
	    return atts;
	}
