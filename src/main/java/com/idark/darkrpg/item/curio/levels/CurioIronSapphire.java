...
public class CurioIronSapphire extends RPGCurioItem {
	private static final ResourceLocation TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/iron_necklace_sapphire.png");	
	public CurioIronSapphire(Properties properties) {
        super(properties);
	}
