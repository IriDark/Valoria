...
public class CurioLeatherGloves extends RPGCurioItem {
	
   private static final ResourceLocation GLOVES_TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/leather_gloves.png");
