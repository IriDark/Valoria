...
public class CurioDiamondGloves extends RPGCurioItem{

    private static final ResourceLocation GLOVES_TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/diamond_gloves.png");
    ...
    public void curioTick(String identifier, int index, LivingEntity livingEntity, ItemStack stack) {
        ...
        if(random.nextFloat() > 1.0f) {
            stack.damageItem(1, player, p -> CuriosApi.getCuriosHelper().onBrokenCurio(SlotTypePreset.HANDS.getIdentifier(), index, p));
        }
    }
