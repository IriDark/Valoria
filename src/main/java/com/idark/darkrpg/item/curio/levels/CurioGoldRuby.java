...
public class CurioGoldRuby extends RPGCurioItem {
	
   public CurioGoldRuby(Properties properties) {
        super(properties);
	}
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        ...
        atts.put(Attributes.MAX_HEALTH, new AttributeModifier(uuid, "bonus", 1.5, AttributeModifier.Operation.ADDITION));
		return atts;
		}
