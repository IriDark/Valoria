...
public class CurioNetheriteRing extends RPGCurioItem {
	
   private static final ResourceLocation RING_TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/entity/netherite_ring.png");
