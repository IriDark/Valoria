...
public class HandsRenderer implements ICurioRenderer {
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext,
        ...
        if (!isDefault(slotContext.entity())) {
            ...
            if (model == null) {
                model = new HandsModel(Minecraft.getInstance().getEntityModels().bakeLayer(DarkRPGClient.HANDS_LAYER_SLIM));
            }
            ...
            if (model == null) {
                model = new HandsModelDefault(Minecraft.getInstance().getEntityModels().bakeLayer(DarkRPGClient.HANDS_LAYER));
            }
