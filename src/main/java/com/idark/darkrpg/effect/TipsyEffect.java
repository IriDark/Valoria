...
public class TipsyEffect extends Effect {
    ...
    public TipsyEffect() {
		...
		addAttributesModifier(Attributes.MOVEMENT_SPEED, "1107DE5E-7AE8-2030-840A-21B21F160890", (double)-0.5F, AttributeModifier.Operation.MULTIPLY_TOTAL);
   		addAttributesModifier(Attributes.KNOCKBACK_RESISTANCE, "B500EFB0-44AA-4F2B-8310-BEFBF96D540A ", (double)-0.5F, AttributeModifier.Operation.MULTIPLY_TOTAL);
