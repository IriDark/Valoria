...
public class ModEnchantments {
	...
	public static final EnchantmentType FLOW = EnchantmentType.create("flow", item -> item instanceof KunaiItem || item instanceof PoisonedKunaiItem);
    ...
    public static final RegistryObject<Enchantment> FLOW_ENCHANT = ENCHANTMENTS.register("flow_enchant", FlowEnchantment::new);
