package com.idark.darkrpg.toast;
...
public class ModToast implements Toast {
    ...
    public ResourceLocation TEXTURE = new ResourceLocation(DarkRPG.MOD_ID, "textures/gui/toast.png");
    ...
    public Visibility render(GuiGraphics pGuiGraphics, ToastComponent pToastComponent, long pTimeSinceLastVisible) {
        ...
        if (pUnlock) {
            drawWrappingText(pGuiGraphics, "gui.darkrpg.new_page", 90, 8, 120, true);
        } else {
            drawWrappingText(pGuiGraphics, "gui.darkrpg.delete_page", 92, 12, 120, true);
        }
